...
70 // 16 = **4** reste **6**. Donc les empreintes valides sont celles qui commencent par **4** zéros et dont le 5<sup>ème</sup> caractère est entre 0 et 5 (car on commence a zéro donc le chiffre 5 est déjà le 6 ème caractère possible). On écrit alors que les empreintes valides commencent par : `0000[0-5]`
